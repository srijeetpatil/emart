            ...
            return(                
                <div>
                    <Link className="row" style={{margin:"10px 10px 10px 10px", textDecoration:"none"}} onClick={() => {
                        ...
                        <div style={{marginTop:"auto", marginBottom:"auto", marginLeft:"5px", marginRight:"5px"}}>{name}</div>
                        <i className="fa fa-caret-down" style={{marginTop:"auto", marginBottom:"auto"}}></i>
                    </Link>
